//this test the origina words and reverse
...
//get the string 
	string<char> toTest;
	for (long a = 0; a < pow(2, length); a++)
	{

		std::cout << "percentage:" << (float) a / pow(2, length) << std::endl;
...
//for this string and its reverse
...
//the original word is not in it, add it in
		language += str;
...
///////////////////////////[part 2 the reverse string]
	str = str.reverse();

	std::cout << " and " << str << std::endl;
...
//std::cout<<"The fcm is "<<std::endl<<dfca;
	...
	std::cout << "The samllest dfca for word " << " is " << std::endl
